...
const UpdateHouse = () => {
    ...
    const {
      ...
      const onSubmit = (data) => {
        const {address,availability_date,bathrooms,bedrooms, city, house_name, owner_email, owner_name, phone_number, picture, rent_per_month, room_size} = data

        const updateHouse = {address,availability_date,bathrooms,bedrooms, city, house_name, owner_email, owner_name, phone_number, picture, rent_per_month, room_size}
